"""
Django settings for trackify_app project.
...
SECRET_KEY = 'django-insecure--^th&*ihe47_%fdfs97cedrf&fqko9o6-7b1vef^-%ce$=p3!%'
...
ROOT_URLCONF = 'trackify_app.urls'
...
WSGI_APPLICATION = 'trackify_app.wsgi.application'
